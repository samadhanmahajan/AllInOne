...
public class Utility {
	...
	public static void send(String toEmail, String subject, String body) {
		//final String fromEmail = "sarikabarge1996@gmail.com"; // requires valid gmail id
		//System.out.println("password :"+password);
		//final String password="asmita@123";
	...
	public static String getUrl(Long id) {
		...
		return "http://localhost:8011/userController/" + tokenUtil.createToken(id);
	}
